...
impl Piece {
    ...
    pub fn get_move_dirs(self) -> std::vec::Vec<Direction> {
        match self {
            ...
            Piece::WSilverX => vec![Direction::N,
                                    Direction::NE,
                                    Direction::E,
                                    Direction::S,
                                    Direction::W,
            ...
            Piece::BSilverX => vec![Direction::N,
                                    Direction::E,
                                    Direction::SE,
                                    Direction::S,
                                    Direction::SW,
...
pub const PIECE_ALL: [Piece; 20] = [Piece::WKing,
                                    Piece::WGold,
                                    Piece::WSilver,
                                    Piece::WBishop,
                                    Piece::WRook,
                                    ...
                                    Piece::BRookX,
                                    Piece::BPawnX];
pub const PIECE_TYPE_ALL: [PieceType; 10] = [PieceType::King,
                                             PieceType::Gold,
                                             PieceType::Silver,
                                             PieceType::Bishop,
                                             PieceType::Rook,
...
pub const DIRECTION_ALL: [Direction; 8] = [Direction::N,
                                           Direction::NE,
                                           Direction::E,
                                           Direction::SE,
                                           Direction::S,
