...
class Network:
    def __init__(self):
        ...
        # 入力層、出力層を定義
        self.model = keras.Model(inputs=input_image, outputs=[value])
    ...
    def step(self, train_images, policy_label, value_label, batch_size, epochs=1):
        print('debug', train_images.shape)
        self.model.fit(train_images, [value_label], batch_size=batch_size, epochs=epochs)
